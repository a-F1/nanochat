...
# a-F1
# Sed
parser.add_argument("--sed-val", type=float, default=0.0, help="SED parameter for the elastic phase (default: 0.0)")
parser.add_argument("--muon-percent", type=float, default=0.9, help="Percentage of total iterations to use Muon before switching to SED (default: 0.9)")
...
optimizer = model.setup_sed_optimizer(
    ...
    sed_val=args.sed_val,
    muon_percent=args.muon_percent,
