...
# a-F1
# Forge Optimizer Hyper-parameters
parser.add_argument("--ns-steps", type=int, default=5, help="Total number of Newton-Schulz iterations for Forge (default: 5)")
parser.add_argument("--expand-steps", type=int, default=1, help="Number of amplification (expand) steps in Forge before filtering (default: 1)")
...
optimizer = model.setup_forge_optimizer(
    # AdamW hyperparameters
    unembedding_lr=args.unembedding_lr * batch_lr_scale,
    embedding_lr=args.embedding_lr * batch_lr_scale,
    scalar_lr=args.scalar_lr * batch_lr_scale,
    adam_betas=(args.adam_beta1, args.adam_beta2),
    # Forge hyperparameters
    matrix_lr=args.matrix_lr * batch_lr_scale,
    weight_decay=weight_decay_scaled,
    ns_steps=args.ns_steps,          # 传入总迭代次数
    expand_steps=args.expand_steps,  # 传入推斥放大的次数
)
